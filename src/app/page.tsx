        ...
        <div className="py-10 md:py-20 px-10">
          ...
          <div className="flex flex-col justify-center mt-20 p-6 gap-y-10">
            ...
            <div className="flex flex-col gap-10 text-center my-10">
              <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugiat tempore totam suscipit nulla soluta ab
                sequi ratione omnis incidunt quaerat.</p>

              <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eum itaque magnam quibusdam nam esse modi
                porro incidunt unde dolorum aliquam.</p>
            </div>
